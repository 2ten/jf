...
class Alliance_JulienReviews_Block_View_List extends Mage_Core_Block_Template
{
    ...
    public function __construct()
    {
		...
		$final_collection = Mage::getResourceModel('alliance_julienreviews/review_collection');
		...
		$this->setCollection($final_collection);
    }
    ...
    protected function _loadReviewCount()
    {
        $this->review_count = $this->_collection->count();
    }
    ...
    {
        $link = '/julienreviews/write/index/id/';
    ...
    {
        $collection = Mage::getResourceModel('alliance_julienreviews/helpful_collection');
        $collection->addFieldToFilter('review_id', array(
            'eq' => $review_id,
        ));

        $collection2 = Mage::getResourceModel('alliance_julienreviews/helpful_collection');
        ...
        $collection3 = Mage::getResourceModel('alliance_julienreviews/helpful_collection');
    ...
    {
        $model = Mage::getModel('catalog/product')->load($this->product_id);

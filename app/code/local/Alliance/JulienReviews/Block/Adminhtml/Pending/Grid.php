...
class Alliance_JulienReviews_Block_Adminhtml_Pending_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setId('alliance_julienreviews_pending_grid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('action_approve', array(
            'header'   => $this->helper('alliance_julienreviews')->__('Approve'),
            'width'    => 15,
            'sortable' => false,
            'filter'   => false,
            'type'     => 'action',
            ...
            'actions'  => array(
                array(
                    ...
                    'field'   => 'id',
                    'caption' => $this->helper('alliance_julienreviews')->__('Approve'),
                ),
            )
        ));

        $this->addColumn('action_deny', array(
            'header'   => $this->helper('alliance_julienreviews')->__('Deny'),
            'width'    => 15,
            'sortable' => false,
            'filter'   => false,
            'type'     => 'action',
            ...
            'actions'  => array(
                array(
                    ...
                    'field'   => 'id',
                    'caption' => $this->helper('alliance_julienreviews')->__('Deny'),
                ),
            )
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('approve', array(
            'label'=> Mage::helper('alliance_julienreviews')->__('Approve'),
            'url'  => $this->getUrl('*/*/massPendingApprove', array('' => '')),
        ));
        $this->getMassactionBlock()->addItem('deny', array(
            'label'=> Mage::helper('alliance_julienreviews')->__('Deny'),
            'url'  => $this->getUrl('*/*/massPendingDeny', array('' => '')),
        ));
        $this->getMassactionBlock()->addItem('delete', array(
            'label'=> Mage::helper('alliance_julienreviews')->__('Delete'),
            'url'  => $this->getUrl('*/*/massPendingDelete', array('' => '')),
            'confirm' => Mage::helper('alliance_julienreviews')->__('Are you sure? The selected reviews will be permanently deleted. This cannot be undone.')
        ));
        return $this;
    }

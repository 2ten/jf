...
class SFC_CimCore_Model_Cim_Payment_Profile extends Mage_Core_Model_Abstract
{
    /**
     * Construct
     */
    ...
    public function saveCimProfileData($createCustProfile = false)
    {
        ...
        $this->setData('customer_cardnumber',
            SFC_CimCore_Helper_Cim::CC_MASK . substr($this->getData('customer_cardnumber'), -4, 4));
    }

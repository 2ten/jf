...
class SFC_CimCore_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * Constants
     */
    // Log file name
    const LOG_FILE = 'sfc_cim_core.log';

    /**
     * Example of how logging should be done in this extension:
     *     Mage::log($message, Zend_Log::ERR, SFC_CimCore_Helper_Data::LOG_FILE);
     */

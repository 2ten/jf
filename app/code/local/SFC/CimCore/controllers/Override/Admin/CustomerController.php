...
class SFC_CimCore_Override_Admin_CustomerController extends Mage_Adminhtml_CustomerController
{
    ...
    {
        $collection = Mage::getModel('sfc_cim_core/cim_payment_profile')->getCollection()->addfilter('customer_id', $customerId);

 ...
 *
 */
class SFC_CimSaved_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * Constants
     */
    // Log file name
    const LOG_FILE = 'sfc_cim_saved.log';

    /**
     * Example of how logging should be done in this extension:
     *     Mage::log($message, Zend_Log::ERR, SFC_CimSaved_Helper_Data::LOG_FILE);
     */

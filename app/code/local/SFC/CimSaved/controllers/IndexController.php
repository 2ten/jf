 ...
 *
 */
class SFC_CimSaved_IndexController extends Mage_Core_Controller_Front_Action
{
    /**
     ...
     *
     * @param SFC_CimCore_Model_Cim_Payment_Profile $cimProfile Profile to authorize against current customer
     * @throws SFC_CimCore_Helper_Cim_Exception
     */
    protected function authorizeCustomerForProfile(SFC_CimCore_Model_Cim_Payment_Profile $cimProfile)
    {
        // Get customer session
        /** @var Mage_Customer_Model_Session $customerSession */
        $customerSession = Mage::getSingleton('customer/session');
        ...
        if ($customerSession->getCustomerId() != $cimProfile->getData('customer_id')) {
            throw new SFC_CimCore_Helper_Cim_Exception('Customer not authorized to edit this profile!');
        }
    }
    ...
    public function newAction()
    {
        ...
        try {
            ...
            /** @var SFC_CimCore_Model_Cim_Payment_Profile $cimProfile */
            $cimProfile = Mage::getModel('sfc_cim_core/cim_payment_profile');
    ...
    public function editAction()
    {
        ...
        try {
            ...
            /** @var SFC_CimCore_Model_Cim_Payment_Profile $cimProfile */
            $cimProfile = Mage::getModel('sfc_cim_core/cim_payment_profile')->load($profileId);
            // Authorize customer
    ...
    protected function _addErrorFromCimException(SFC_CimCore_Helper_Cim_Exception $eCim)
    {
        // Get core session
        /** @var Mage_Core_Model_Session $coreSession */
        $coreSession = Mage::getSingleton('core/session');
